            ...
            <div class="cont">
                <div class="row mt-2">
                    <div class="col text-center p-5">
                        <img class="img-fluid project-image w-100" src="{{asset("projets/boids/header.png")}}" alt=""></img>
                    </div>
                    <div class="col p-5">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col"><p><span class="bold">Technos :</span> C</p></div>
                ...
                <div class="row">
                    ...
                    <div class="col text-center">
                        <img class="project-image" src="{{asset("projets/boids/snake.png")}}" alt=""></img>
                    </div>
                </div>
            </div>
        </div>
